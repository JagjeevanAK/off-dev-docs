...
Note that if you [use direnv](how-to-use-direnv.mdx), the setup should work seamlessly without redefining the variables set by `setenv.sh`.

An explanation of the setup can be found at [explain-pro-dev-setup.md](explain-pro-dev-setup.mdx)
