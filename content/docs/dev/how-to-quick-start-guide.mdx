...
As an alternative to setting up your environment locally, follow the [Gitpod how-to guide](how-to-use-gitpod.mdx)
...
> **_NOTE:_**  New to Perl? Check [how to learn perl](how-to-learn-perl.mdx)!
...
On linux and macOS, you can automatically do it if you [use direnv](how-to-use-direnv.mdx).
...
```
> **Note:**
> To know more about docker compose commands do read [this guide](how-to-develop-using-docker.mdx)
